...
public class Records {
	...
	public ArrayList<Game> GameKeeper(){
		ArrayList<Game> gamelist = new ArrayList<Game>();
		//Running Game
		gamelist.add(new RunningGame("R01",1));
		gamelist.add(new RunningGame("R02",2));
		//Swimming Game
		gamelist.add(new SwimmingGame("S03",3));
		gamelist.add(new SwimmingGame("S04",4));
		//Cycling Game
		gamelist.add(new CyclingGame("C05",1));
		gamelist.add(new CyclingGame("C06",2));
		return gamelist;
	}
	//Official records
	public ArrayList<Official> OfficialRecordsKeeper(){
		ArrayList<Official> officialList = new ArrayList<Official>();
		officialList.add(new Official(1,"A",24,"VIC"));
		officialList.add(new Official(2,"B",26,"JBT"));
		officialList.add(new Official(3,"C",19,"VIC"));
		officialList.add(new Official(4,"D",23,"SA"));
		return officialList;
	}
